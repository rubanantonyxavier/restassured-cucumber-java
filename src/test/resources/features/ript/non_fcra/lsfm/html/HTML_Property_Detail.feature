...
@property
@detail
Feature: LSFM HTML Property Detail Section

  @market_analysis
  @MADLRVP-9135
  Scenario: [MADLRVP-9135] Verify LSFM HTML - PROPERTY DETAIL - Market Analysis
    Given the request XML filepath is /ript/non_fcra/lsfm/html/MADLRVP-9135.xml
  ...
  @MADLRVP-9136
  Scenario: [MADLRVP-9136] Verify LSFM HTML - PROPERTY DETAIL - Subject Property Analysis
    Given the request XML filepath is /ript/non_fcra/lsfm/html/MADLRVP-9136.xml
    When the request is sent
    Then response content type is HTML
    And HTML response doesn't contain any ERROR message
    And the HTML response has xpath with TEXT content
  ...
  @MADLRVP-9137
  Scenario: [MADLRVP-9137] Verify LSFM HTML - PROPERTY DETAIL - Most Recent MLS Listing Information
    Given the request XML filepath is /ript/non_fcra/lsfm/html/MADLRVP-9137.xml
    When the request is sent
    Then response content type is HTML
    And HTML response doesn't contain any ERROR message
    And the HTML response has xpath with TEXT content
  ...
  @area_map
  @MADLRVP-9138
  Scenario: [MADLRVP-9138] Verify LSFM HTML - PROPERTY DETAIL - Heat Map and Area Map
    Given the request XML filepath is /ript/non_fcra/lsfm/html/MADLRVP-9138.xml
    When the request is sent
    Then response content type is HTML
    And HTML response doesn't contain any ERROR message
    And the HTML response has xpath with TEXT content
    ...
    And the HTML response has xpath with IMAGE content
      ...
      | //div[@id='HP_AREA_MAP']//div[@class='maplegend']/img[1]  | /PCFRSWebElements/images/ui/lsfm/letters/subject.gif                          |
      | //div[@id='HP_AREA_MAP']//div[@class='maplegend']/img[2]  | /PCFRSWebElements/images/ui/lsfm/ui/full_sale/full_sale_empty.gif             |
      | //div[@id='HP_AREA_MAP']//div[@class='maplegend']/img[3]  | /PCFRSWebElements/images/ui/lsfm/ui/distressed_sale/distressed_sale_empty.gif |
  ...
  @MADLRVP-9139
  Scenario: [MADLRVP-9139] Verify LSFM HTML - PROPERTY DETAIL - RECENT SUBJECT PROPERTY RESALE SUMMARY
    Given the request XML filepath is /ript/non_fcra/lsfm/html/MADLRVP-9139.xml
    When the request is sent
    Then response content type is HTML
    And HTML response doesn't contain any ERROR message
    And the HTML response has xpath with TEXT content
  ...
  @first_section
  @MADLRVP-9140
  Scenario: [MADLRVP-9140] Verify LSFM HTML - PROPERTY DETAIL - SUBJECT PROPERTY REPORT - First Section
    Given the request XML filepath is /ript/non_fcra/lsfm/html/MADLRVP-9140.xml
    When the request is sent
    Then response content type is HTML
    And HTML response doesn't contain any ERROR message
    And the HTML response has xpath with TEXT content
      ...
      | //table[@class='gray_text_table']//tr[1]/td[1]/b                         | Site Address:           |
      | //table[@class='gray_text_table']//tr[1]/td[2]                           | [NOT EMPTY]             |
      | //table[@class='gray_text_table']//tr[2]/td[1]/b                         | Mail Address:           |
      | //table[@class='gray_text_table']//tr[2]/td[2]                           | [NOT EMPTY]             |
      | //table[@class='gray_text_table']//tr[3]/td[1]/b                         | Current Owner:          |
      | //table[@class='gray_text_table']//tr[3]/td[2]                           | [NOT EMPTY]             |
      | //table[@class='gray_text_table']//tr[4]/td[1]/b                         | Second Owner:           |
      | //table[@class='gray_text_table']//tr[4]/td[2]                           | [NOT EMPTY]             |
  ...
  @MADLRVP-9141
  Scenario: [MADLRVP-9141] Verify LSFM HTML - PROPERTY DETAIL - SUBJECT PROPERTY REPORT - Second Section: SUBJECT PROPERTY DETAILS
    Given the request XML filepath is /ript/non_fcra/lsfm/html/MADLRVP-9141.xml
    When the request is sent
    Then response content type is HTML
    And HTML response doesn't contain any ERROR message
    And the HTML response has xpath with TEXT content
...
#Subject_Property_Sales_And_Loan_History
    ...
    And the HTML response has ON-CLICK elements in each XPath that end with the expected content
      ...
      | //table[@class='property_loanHistory data']//a[contains(text(),'REFI')]           | /PCFRSWebElements/html/RiPTCodeValue.HTML#loan_type        |
  ...
  @MADLRVP-9142
  Scenario: [MADLRVP-9142] Verify LSFM HTML - PROPERTY DETAIL - NEARBY PROPERTIES REVIEW - PRICES FOR NEARBY SALES
    Given the request XML filepath is /ript/non_fcra/lsfm/html/MADLRVP-9142.xml
    When the request is sent
    Then response content type is HTML
    And HTML response doesn't contain any ERROR message
    And the HTML response has xpath with TEXT content
    ...
    And the HTML response has xpath with IMAGE content
      | XPath                                     | expected                                                                      |
      | //div[@id='pricegraphlegend']/span[1]/img | /PCFRSWebElements/images/ui/lsfm/ui/full_sale/full_sale_empty.gif             |
      | //div[@id='pricegraphlegend']/span[2]/img | /PCFRSWebElements/images/ui/lsfm/ui/distressed_sale/distressed_sale_empty.gif |

  @nearby_properties_review
  @nearby_sales
  @summary
  @MADLRVP-9143
  Scenario: [MADLRVP-9143] Verify LSFM HTML - PROPERTY DETAIL - NEARBY PROPERTIES REVIEW - NEARBY SALES SUMMARY
    Given the request XML filepath is /ript/non_fcra/lsfm/html/MADLRVP-9143.xml
    When the request is sent
    Then response content type is HTML
    And HTML response doesn't contain any ERROR message
    And the HTML response has xpath with TEXT content
  ...
  @full_value
  @MADLRVP-9144
  Scenario: [MADLRVP-9144] Verify LSFM HTML - PROPERTY DETAIL - NEARBY PROPERTIES REVIEW - NEARBY SALES FULL VALUE
    Given the request XML filepath is /ript/non_fcra/lsfm/html/MADLRVP-9144.xml
    When the request is sent
    Then response content type is HTML
    And HTML response doesn't contain any ERROR message
    And the HTML response has xpath with TEXT content
...
#Nearby_Sales-Full_Value_Sales_History
    ...
    And the HTML response has ON-CLICK elements in each XPath that end with the expected content
      | XPath                                                                 | expected                                           |
      | //div[@id='lsfm_full_value_nearby_sales']//a[contains(text(),'RCON')] | /PCFRSWebElements/html/RiPTCodeValue.HTML#use_code |

  @nearby_properties_review
  @nearby_sales
  @foreclosure_bank-owned_short-sale
  @MADLRVP-9145
  Scenario: [MADLRVP-9145] Verify LSFM HTML - PROPERTY DETAIL - NEARBY PROPERTIES REVIEW - NEARBY SALES - FORECLOSURE/BANK-OWNED/SHORT-SALE
    Given the request XML filepath is /ript/non_fcra/lsfm/html/MADLRVP-9145.xml
    When the request is sent
    Then response content type is HTML
    And HTML response doesn't contain any ERROR message
    And the HTML response has xpath with TEXT content
...
#Nearby_Sales-FORECLOSURE/BANK_OWNED/SHORT_SALE_Sales_History
  ...
  @MADLRVP-9146
  Scenario: [MADLRVP-9146] Verify LSFM HTML - PROPERTY DETAIL - NEARBY PROPERTIES REVIEW - CLOSEST PROPERTY RECORDS
    Given the request XML filepath is /ript/non_fcra/lsfm/html/MADLRVP-9146.xml
    When the request is sent
    Then response content type is HTML
    And HTML response doesn't contain any ERROR message
    And the HTML response has xpath with TEXT content
