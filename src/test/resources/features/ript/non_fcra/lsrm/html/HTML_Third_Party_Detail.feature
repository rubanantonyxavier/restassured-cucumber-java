...
@third_party
@detail
Feature: LSRM HTML Third Party Detail Section

  @nmls_consumer_access
  @nmls_state_license_search
  @MADLRVP-9309
  Scenario: [MADLRVP-9309] Verify LSRM HTML - THIRD PARTY DETAIL - NMLS Consumer Access - NMLS State License Search
    Given the request XML filepath is /ript/non_fcra/lsrm/html/MADLRVP-9309.xml
  ...
  @MADLRVP-9310
  Scenario: [MADLRVP-9310] Verify LSRM HTML - THIRD PARTY DETAIL - NMLS Consumer Access - NMLS Federal Registration Search
    Given the request XML filepath is /ript/non_fcra/lsrm/html/MADLRVP-9310.xml
    When the LSRM request is sent
    Then response content type is HTML
    And HTML response doesn't contain any ERROR message
    And the HTML response has xpath with TEXT content
      | XPath                                                                 | expected                         |
      | //div[@id='NMLS_REGISTRY']/div[2]/div[2]/table//table[1]//b           | NMLS Federal Registration Search |
      | //div[@id='NMLS_REGISTRY']/div[2]/div[2]/table//table[2]//tr[2]/td[1] | SEARCHED BY                      |
      | //div[@id='NMLS_REGISTRY']/div[2]/div[2]/table//table[2]//tr[2]/td[2] | NAME / ADDRESS                   |
      | //div[@id='NMLS_REGISTRY']/div[2]/div[2]/table//table[2]//tr[2]/td[3] | NMLS ID                          |
      | //div[@id='NMLS_REGISTRY']/div[2]/div[2]/table//table[2]//tr[2]/td[4] | REG.                             |
      | //div[@id='NMLS_REGISTRY']/div[2]/div[2]/table//table[2]//tr[2]/td[5] | STATUS / DATE                    |
      | //div[@id='NMLS_REGISTRY']/div[2]/div[2]/table//table[2]//tr[2]/td[6] | MESSAGE/ EMPLOYER                |

  @derogatory_lists
  @MADLRVP-9311
  Scenario: [MADLRVP-9311] Verify LSRM HTML - THIRD PARTY DETAIL - DEROGATORY LISTS
    Given the request XML filepath is /ript/non_fcra/lsrm/html/MADLRVP-9311.xml
    When the LSRM request is sent
    Then response content type is HTML
    And HTML response doesn't contain any ERROR message
    And the HTML response has xpath with TEXT content
...
#Government_Watch_List-Table1_Sub-Section
  ...
  @ofac
  @MADLRVP-9312
  Scenario: [MADLRVP-9312] Verify LSRM HTML - THIRD PARTY DETAIL - OFAC
    Given the request XML filepath is /ript/non_fcra/lsrm/html/MADLRVP-9312.xml
    When the LSRM request is sent
    Then response content type is HTML
    And HTML response doesn't contain any ERROR message
    And the HTML response has xpath with TEXT content
      ...
      | //div[@id='OFAC_3RD_PARTY_CUST_DETAILS']//div                         | OFAC Record for Review |
  ...
  @MADLRVP-9313
  Scenario: [MADLRVP-9313] Verify LSRM HTML - THIRD PARTY DETAIL - SETTLEMENT AGENT RISK ASSESSMENT
    Given the request XML filepath is /ript/non_fcra/lsrm/html/MADLRVP-9313.xml
    When the LSRM request is sent
    Then response content type is HTML
    And HTML response doesn't contain any ERROR message
    And the HTML response has xpath with TEXT content
...
#Settlement_Agent_Risk_Assessment-Agent_Information
      | //div[@id='saraSummary0']/div[2]/div[2]/div/div[3]/div[1]          | Agent Information                |
      | //div[@id='saraSummary0']/div[2]/div[2]/div/div[3]/table[1]//th[1] | Secure Insight #                 |
      | //div[@id='saraSummary0']/div[2]/div[2]/div/div[3]/table[1]//td[1] | [NOT EMPTY]                      |
      | //div[@id='saraSummary0']/div[2]/div[2]/div/div[3]/table[1]//th[2] | Name                             |
      | //div[@id='saraSummary0']/div[2]/div[2]/div/div[3]/table[1]//td[2] | [NOT EMPTY]                      |
      | //div[@id='saraSummary0']/div[2]/div[2]/div/div[3]/table[1]//th[3] | Role                             |
      | //div[@id='saraSummary0']/div[2]/div[2]/div/div[3]/table[1]//td[3] | [NOT EMPTY]                      |
      | //div[@id='saraSummary0']/div[2]/div[2]/div/div[3]/table[1]//th[4] | Business Address                 |
      | //div[@id='saraSummary0']/div[2]/div[2]/div/div[3]/table[1]//td[4] | [NOT EMPTY]                      |
      | //div[@id='saraSummary0']/div[2]/div[2]/div/div[3]/table[1]//th[5] | Business Phone                   |
      | //div[@id='saraSummary0']/div[2]/div[2]/div/div[3]/table[1]//td[5] | [NOT EMPTY]                      |
#Settlement_Agent_Risk_Assessment-Registration_Information
      | //div[@id='saraSummary0']/div[2]/div[2]/div/div[3]/div[2]          | Registration Information         |
      | //div[@id='saraSummary0']/div[2]/div[2]/div/div[3]/table[2]//th[1] | Risk Rating                      |
      | //div[@id='saraSummary0']/div[2]/div[2]/div/div[3]/table[2]//td[1] | [NOT EMPTY]                      |
      | //div[@id='saraSummary0']/div[2]/div[2]/div/div[3]/table[2]//th[2] | Vetting Level                    |
      | //div[@id='saraSummary0']/div[2]/div[2]/div/div[3]/table[2]//td[2] | [NOT EMPTY]                      |
      | //div[@id='saraSummary0']/div[2]/div[2]/div/div[3]/table[2]//th[3] | Watch Status                     |
      | //div[@id='saraSummary0']/div[2]/div[2]/div/div[3]/table[2]//td[3] | [NOT EMPTY]                      |
      | //div[@id='saraSummary0']/div[2]/div[2]/div/div[3]/table[2]//th[4] | Watch Source                     |
      | //div[@id='saraSummary0']/div[2]/div[2]/div/div[3]/table[2]//td[4] | [NOT EMPTY]                      |
      | //div[@id='saraSummary0']/div[2]/div[2]/div/div[3]/table[2]//th[5] | Registration Status              |
      | //div[@id='saraSummary0']/div[2]/div[2]/div/div[3]/table[2]//td[5] | [NOT EMPTY]                      |
      | //div[@id='saraSummary0']/div[2]/div[2]/div/div[3]/table[2]//th[6] | Registration Expiration          |
      | //div[@id='saraSummary0']/div[2]/div[2]/div/div[3]/table[2]//td[6] | [NOT EMPTY]                      |
#Settlement_Agent_Risk_Assessment-License_Information
      | //div[@id='saraSummary0']/div[2]/div[2]/div/div[3]/div[3]          | License Information              |
      | //div[@id='saraSummary0']/div[2]/div[2]/div/div[3]/table[3]//th[1] | Group                            |
      | //div[@id='saraSummary0']/div[2]/div[2]/div/div[3]/table[3]//th[2] | License #                        |
      | //div[@id='saraSummary0']/div[2]/div[2]/div/div[3]/table[3]//th[3] | License Type                     |
      | //div[@id='saraSummary0']/div[2]/div[2]/div/div[3]/table[3]//th[4] | State                            |
#Settlement_Agent_Risk_Assessment-Expiration_Dates
      | //div[@id='saraSummary0']/div[2]/div[2]/div/div[3]/div[4]          | Expiration Dates                 |
      | //div[@id='saraSummary0']/div[2]/div[2]/div/div[3]/table[4]//th[1] | Expired Item(s)                  |
      | //div[@id='saraSummary0']/div[2]/div[2]/div/div[3]/table[4]//th[2] | Next Expiration Date             |
