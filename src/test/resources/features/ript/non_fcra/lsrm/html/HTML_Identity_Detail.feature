...
@identity
@section
Feature: LSRM HTML IDENTITY DETAIL Section

  @no_bankruptcy
  @MADLRVP-9298
  Scenario: [MADLRVP-9298] Verify LSRM HTML - IDENTITY SUMMARY - No Bankruptcies found
    Given the request XML filepath is /ript/non_fcra/lsrm/html/MADLRVP-9298_NoBankruptcy.xml
    ...
    And the HTML response has xpath with IMAGE content
      | XPath                                                           | expected                                                   |
      | //div[@id='identityDetail']/img[@alt='Identity Detail Section'] | /PCFRSWebElements/images/ui/lsrm/identity_detail_white.gif |
    And the HTML response has xpath with TEXT content
      | XPath                                                                 | expected                                             |
      | //div[@id='idSummaryBorrower0']//div[@class='text']//b                | IDENTITY SUMMARY: KIRKARZI, HOWARD                   |
      | //div[@id='idSummaryBorrower0']/div[2]/table[1]//table//b             | SSN has not been issued or has been randomly issued. |
      | //div[@id='idSummaryBorrower0']/div[2]/table[2]//table[1]//b          | BEST MATCH                                           |
      | //div[@id='idSummaryBorrower0']/div[2]/table[2]//table[2]//td[1]/b    | Name: SSN: SSN Issue State: Approx. SSN Issue Years: |
      | //div[@id='idSummaryBorrower0']/div[2]/table[2]//table[2]//td[2]/b    | Date Reported: Date of Birth:                        |
      | //div[@id='idSummaryBorrower0']/div[2]/table[2]//table[2]//td[3]/b    | AKA                                                  |
  ...
  @bankruptcy
  @MADLRVP-9298
  Scenario: [MADLRVP-9298] Verify LSRM HTML - IDENTITY SUMMARY - Bankruptcies found
    Given the request XML filepath is /ript/non_fcra/lsrm/html/MADLRVP-9298_Bankruptcy.xml
    When the LSRM request is sent
    Then response content type is HTML
    And HTML response doesn't contain any ERROR message
    And the HTML response has xpath with IMAGE content
...
#  BANKRUPTCY
  ...
  @MADLRVP-9299
  Scenario: [MADLRVP-9299] Verify LSRM HTML - WATCHLIST SEARCHES - OFAC check
    Given the request XML filepath is /ript/non_fcra/lsrm/html/MADLRVP-9299.xml
    When the LSRM request is sent
    Then response content type is HTML
    And HTML response doesn't contain any ERROR message
    And the HTML response has xpath with TEXT content
      ...
      | //div[@id='IDENTITY_OFAC0']/table/tbody/tr[2]/td[2]/div[1]            | OFAC Record for Review            |
  ...
  @MADLRVP-9300
  Scenario: [MADLRVP-9300] Verify LSRM HTML - WATCHLIST SEARCHES - Government Watch List check
    Given the request XML filepath is /ript/non_fcra/lsrm/html/MADLRVP-9300.xml
    When the LSRM request is sent
    Then response content type is HTML
    And HTML response doesn't contain any ERROR message
    And the HTML response has xpath with IMAGE content
    ...
    And the HTML response has xpath with TEXT content
      | XPath                                                                                | expected                              |
      | //div[@id='idDerogatoryBorrower0']//*[@class='wide_letter_spacing']/b                | WATCHLIST SEARCHES: Hamilton, Timothy |
