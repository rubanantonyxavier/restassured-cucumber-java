...
@property_detail
@market_analysis
Feature: LSFM FCRA - Property Detail Section - Market Analysis

  @MADLRVP-10399
  Scenario Outline: [MADLRVP-10399] Verify LSFM FCRA - HP_001 is fired when zip and fips deemed as a disaster area
    Given the request XML filepath is /ript/fcra/lsfm/sections/property_detail/MADLRVP-10399.xml
  ...
  @MADLRVP-10401
  Scenario Outline: [MADLRVP-10401] Verify LSFM FCRA - HP_001 is NOT when zip is deemed as a disaster area but fips is not
    Given the request XML filepath is /ript/fcra/lsfm/sections/property_detail/MADLRVP-10401.xml
    When the LSFM FCRA request is sent
    Then response content type is XML
    And successful LSFM report is received
    And the response contains xpath
