package com.automation.services.allure;
...
public class AllureRestAssuredCustomLogger extends AllureRestAssured {
    private static final String REQUEST_TEMPLATE_PATH = "http-request.ftl";
    ...
    public Response filter(final FilterableRequestSpecification requestSpec,
        ...
        final HttpRequestAttachment.Builder requestAttachmentBuilder = create(REQUEST_ATTACHMENT_NAME, url)
